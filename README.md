...
npm install --prefix frontend      # Install the dedicated Vite app deps
...
├── backend/                     # Dedicated local API service
├── frontend/                    # Dedicated Vite + React app
├── config/
...
├── output/                      # Generated PDFs and markdown outputs (gitignored)
