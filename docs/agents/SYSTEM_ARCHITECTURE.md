...
| Shared contracts    | `../../shared/contracts/api-contract.mjs`, `../../shared/contracts/api-contract.d.ts`, `../../shared/contracts/api-contract.mjs.d.ts` | Centralizes canonical request/response shapes plus lightweight typing support.                                   |
